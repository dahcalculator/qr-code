  ...
  return (
    <div className="  flex-col flex gap-4 w-full h-full">
        ...
        <div className="  rounded-md flex-row flex gap-20 justify-evenly capitalize w-full h-32 bg-white "  key={c.id}>
            ...
            <div className="text-sm font-bold bg-white h-full w-full flex items-end  justify-end " > <Link className="hover:bg-blue-400 hover:text-white w-36 h-12 flex justify-center items-center rounded " href="/case/view"> View</Link> </div>
            </div> 
